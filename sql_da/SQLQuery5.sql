...
create table KHENTHUONG_HS_KHOI(
	...
	CONSTRAINT FK_KQLHHK_kt_khoi FOREIGN KEY(Mahocsinh) REFERENCES HOCSINH(Mahocsinh),
	CONSTRAINT FK_KQLHHK_kt_khoi_m FOREIGN KEY(Makhenthuong) REFERENCES KHENTHUONG(Makhenthuong),
)
...
create table KHENTHUONG_HS_TRUONG(
	...
	CONSTRAINT FK_KQLHHK_kt_truong FOREIGN KEY(Makhenthuong) REFERENCES KHENTHUONG(Makhenthuong),
	CONSTRAINT FK_KQLHHK_kt_truong_ms FOREIGN KEY(Mahocsinh) REFERENCES HOCSINH(Mahocsinh),
)
...
create table KHENTHUONG_CANHAN ( 
	...
	CONSTRAINT FK_KQLHHK_kt_cn FOREIGN KEY(Makhenthuong) REFERENCES KHENTHUONG(Makhenthuong),
	CONSTRAINT FK_KQLHHK_kt_cn_ms FOREIGN KEY(Mahocsinh) REFERENCES HOCSINH(Mahocsinh),
)
